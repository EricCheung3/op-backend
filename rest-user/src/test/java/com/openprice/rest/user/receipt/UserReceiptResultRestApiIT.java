...
public class UserReceiptResultRestApiIT extends AbstractUserRestApiIntegrationTest {
    ...
    public void getUserReceiptResult_ShouldReturnRecentParsedReceiptResultFromDatabase() throws Exception {
        ...
        .then()
            ...
            .body("_embedded.items[0].id", equalTo("recItem001"))
            .body("_embedded.items[0].catalogCode", equalTo("EGG_1235"))
            .body("_embedded.items[0].parsedName", equalTo("eggs"))
            .body("_embedded.items[0].parsedPrice", equalTo("1.99"))
            .body("_embedded.items[0].catalog.code", equalTo("EGG_1235"))
            .body("_embedded.items[1].id", equalTo("recItem003"))
            .body("_embedded.items[1].catalogCode", equalTo("PORK"))
            .body("_embedded.items[1].parsedName", equalTo("pork"))
            .body("_embedded.items[1].parsedPrice", equalTo("5.99"))
            .body("_embedded.items[1].catalog.code", equalTo("PORK"))
        ;
    }
