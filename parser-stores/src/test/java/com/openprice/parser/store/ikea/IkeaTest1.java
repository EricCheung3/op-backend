...
//        verifyParsedItem(iterator.next(), "nn-fr i 10-9",  ".106", null, 4);
//        verifyParsedItem(iterator.next(), "spec: i i : cust om    ew fr-om t",  "613", null, 5);
...
//        verifyParsedItem(iterator.next(), "wel comt~    to ikea edmo:n on", null, null, 2);
//        verifyParsedItem(iterator.next(), "- 102 st nw    e~n ontun ab", null, null, 3);
//        verifyParsedItem(iterator.next(), "mon -fri 10 -9",  ".106", null, 5);
        ...
        verifyParsedItem(iterator.next(), "artic l e 502j71tl2", null, null, 22);//TODO this is an item number?
...
//        verifyParsedItem(iterator.next(), "mon fr i 10 - 9",  "sun.0", null, 4);
        verifyParsedItem(iterator.next(), "sams nem n 10", null, null, 5);
//        verifyParsedItem(iterator.next(), "r<ifllr n", null, null, 7);
        verifyParsedItem(iterator.next(), "kvartal",  "9.00", null, 8);
//        verifyParsedItem(iterator.next(), "return", null, null, 9);
        verifyParsedItem(iterator.next(), "ingamaj panel",  "18.00", null, 10);
//        verifyParsedItem(iterator.next(), "raturn", null, null, 11);
...
//        verifyParsedItem(iterator.next(), "mon-fri 10-9",  ".106", null, 2);
...
//        verifyParsedItem(iterator.next(), "mon-fri 10-9",  ".106", null, 4);
...
//        verifyParsedItem(iterator.next(), "mon-fr l 10-9",  "sun.0", null, 1);
