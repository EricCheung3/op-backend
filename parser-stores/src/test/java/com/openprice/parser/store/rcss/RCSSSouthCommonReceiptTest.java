...
public class RCSSSouthCommonReceiptTest extends AbstractReceiptParserIntegrationTest{
    ...
    public void testRCSS_2015_02_09_13_15_25() throws Exception {
        ...
        verifyItemParsedValue(iterator.next(), "van bircrm mx    mrj", "3.50", "van bircrm mx    mrj");
        verifyItemParsedValue(iterator.next(), "cm dis prncs cnd    gmrj", "2.99", "cm dis prncs cnd    gmrj");
        verifyItemParsedValue(iterator.next(), "cm scribblers ha    mrj", "4.49", "cm scribblers ha    mrj");
        verifyItemParsedValue(iterator.next(), "dh fc starter    mrj", "2.79", "dh fc starter    mrj");
        verifyItemParsedValue(iterator.next(), "after bite kids    gmrj", "4.99", "after bite kids    gmrj");
        verifyItemParsedValue(iterator.next(), "c&c astringent    gmrj", "6.49", "c&c astringent    gmrj");
        verifyItemParsedValue(iterator.next(), "acne wash    gmrj", "8.49", "acne wash    gmrj");
        verifyItemParsedValue(iterator.next(), "st ives vanilla    gmrj", "2.98", "st ives vanilla    gmrj");
        verifyItemParsedValue(iterator.next(), "shower creme sof    gmrj", "3.93", "shower creme sof    gmrj");
        verifyItemParsedValue(iterator.next(), "wlin cpck dcrtng    gmrj", "5.04", "wlin cpck dcrtng    gmrj");
        verifyItemParsedValue(iterator.next(), "hp jar scraper    gmrj", "5.00", "hp jar scraper    gmrj");
    ...
    public void testRCSS_2015_04_04_21_28_21() throws Exception {
        ...
        verifyItemParsedValue(iterator.next(), "banana    mrj", "4.36", "banana    mrj_4011");
