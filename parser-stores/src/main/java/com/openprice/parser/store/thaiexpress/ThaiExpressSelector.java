...
@Service
public class ThaiExpressSelector extends AbstractStoreParserSelector {
    private ThaiExpress1 parser;
    private static final String CODE="ThaiExpress";

    @Inject
    public ThaiExpressSelector(final ChainRegistry chainRegistry, final StoreMetadata metadata) {
    ...
    protected void generateParser() {
        ...
        parser = new ThaiExpress1(config, loadPriceParserWithCatalog());
    }
