...
@Service
public class RexallSelector extends AbstractStoreParserSelector {
    private Rexall1 parser;
    private static final String CODE="Rexall";

    @Inject
    public RexallSelector(final ChainRegistry chainRegistry, final StoreMetadata metadata) {
    ...
    protected void generateParser() {
        ...
        parser = new Rexall1(config, loadPriceParserWithCatalog());
    }
