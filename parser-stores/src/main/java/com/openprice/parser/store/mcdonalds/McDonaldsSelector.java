...
@Service
public class McDonaldsSelector extends AbstractStoreParserSelector {
    private McDonalds1 parser;
    private final static String CODE="McDonalds";

    @Inject
    public McDonaldsSelector(final ChainRegistry chainRegistry, final StoreMetadata metadata) {
    ...
    protected void generateParser() {
        ...
        parser = new McDonalds1(config, loadPriceParserWithCatalog());
    }
