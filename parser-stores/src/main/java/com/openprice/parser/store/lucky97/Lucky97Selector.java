...
@Service
public class Lucky97Selector extends AbstractStoreParserSelector {
    private Luck971 parser;
    private final static String CODE="Lucky97";

    @Inject
    public Lucky97Selector(final ChainRegistry chainRegistry, final StoreMetadata metadata) {
    ...
    protected void generateParser() {
        ...
        parser = new Luck971(config, loadPriceParserWithCatalog());
    }
