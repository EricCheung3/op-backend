...
@Service
public class SportChekSelector extends AbstractStoreParserSelector {
    private SportChek1 parser;
    private static final String CODE="SportChek";

    @Inject
    public SportChekSelector(final ChainRegistry chainRegistry, final StoreMetadata metadata) {
    ...
    protected void generateParser() {
        ...
        parser = new SportChek1(config, loadPriceParserWithCatalog());
    }
