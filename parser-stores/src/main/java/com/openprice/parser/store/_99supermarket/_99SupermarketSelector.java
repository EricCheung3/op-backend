...
@Service
public class _99SupermarketSelector extends AbstractStoreParserSelector {
    private _99Supermarekt1 parser;
    private static final String CODE="_99supermarket";

    @Inject
    public _99SupermarketSelector(final ChainRegistry chainRegistry, final StoreMetadata metadata) {
    ...
    protected void generateParser() {
        ...
        parser = new _99Supermarekt1(config, loadPriceParserWithCatalog());
    }
