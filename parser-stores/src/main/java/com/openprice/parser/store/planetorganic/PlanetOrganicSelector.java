...
@Service
public class PlanetOrganicSelector extends AbstractStoreParserSelector {
    private PlanetOrganic1 parser;
    private final static String CODE="PlanetOrganic";

    @Inject
    public PlanetOrganicSelector(final ChainRegistry chainRegistry, final StoreMetadata metadata) {
    ...
    protected void generateParser() {
        ...
        parser = new PlanetOrganic1(config, loadPriceParserWithCatalog());
    }
