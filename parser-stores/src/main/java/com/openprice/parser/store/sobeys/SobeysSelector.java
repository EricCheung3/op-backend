...
@Service
public class SobeysSelector extends AbstractStoreParserSelector {
    private Sobeys1 parser;
    private static final String CODE="Sobeys";

    @Inject
    public SobeysSelector(final ChainRegistry chainRegistry, final StoreMetadata metadata) {
    ...
    protected void generateParser() {
        ...
        parser = new Sobeys1(config, loadPriceParserWithCatalog());
    }
