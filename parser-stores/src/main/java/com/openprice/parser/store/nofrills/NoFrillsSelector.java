...
@Service
public class NoFrillsSelector extends AbstractStoreParserSelector {
    private NoFrills1 parser;
    private final static String CODE="NoFrills";

    @Inject
    public NoFrillsSelector(final ChainRegistry chainRegistry, final StoreMetadata metadata) {
    ...
    protected void generateParser() {
        ...
        parser = new NoFrills1(config, loadPriceParserWithCatalog());
    }
