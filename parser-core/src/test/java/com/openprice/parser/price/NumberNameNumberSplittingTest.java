...
public class NumberNameNumberSplittingTest {
    ...
    public void headHasDigits(){
        ...
        final int[] boundaries = NumberNamePriceSplit.cuttingBoundaries(str);
    ...
    public void numDigits1(){
        final NumberNamePriceSplit splitF = new NumberNamePriceSplit("abc123");
    ...
    public void numDigitsDigitIsCounted(){
        final NumberNamePriceSplit splitF = new NumberNamePriceSplit("1abc1.23");
        final int[] arr = splitF.computeNumDigits();
        assertEquals(1, arr[0]);
    ...
    public void SplittingFeaturesTest1DigitsChars(){
        final NumberNamePriceSplit splitF = new NumberNamePriceSplit("1233abc");
    ...
    public void numberNameTest1() throws Exception{
        ...
        final NumberNamePriceSplit splitF = new NumberNamePriceSplit(number+name);
    ...
    public void nameNumberTest7() throws Exception{
        ...
        final String name="ABC";
        final NumberNamePriceSplit splitF = new NumberNamePriceSplit(name+number);
