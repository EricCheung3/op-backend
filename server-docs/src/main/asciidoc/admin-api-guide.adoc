...
[[resources-admin-receipt-items]]
== Admin Receipt Items

Admin Receipt Items is used to retrieve list of items from
one receipt parsing result.


[[resources-admin-receipt-item-list]]
=== List Admin Receipt Parsed Items
...
/*include::{snippets}/admin-receipt-item-list-example/response-fields.adoc[]*/

==== Example request

include::{snippets}/admin-receipt-item-list-example/curl-request.adoc[]

==== Example response

include::{snippets}/admin-receipt-item-list-example/http-response.adoc[]
