...
public interface AdminApiUrls {
    ...
    String URL_ADMIN_USERS_USER_RECEIPTS_UPLOAD = "/admin/users/{userId}/receipts/upload";
    String URL_ADMIN_USERS_USER_RECEIPTS_RECEIPT_IMAGES_UPLOAD = "/admin/users/{userId}/receipts/{receiptId}/images/upload";
