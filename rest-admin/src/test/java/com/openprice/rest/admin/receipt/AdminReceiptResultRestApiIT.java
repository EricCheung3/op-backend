...
public class AdminReceiptResultRestApiIT extends AbstractAdminReceiptRestApiIntegrationTest {
    ...
    public void getReceiptResults_ShouldReturntReceiptResultsFromDatabase() throws Exception {
        ...
        .then()
            ...
            .body("_embedded.receiptDatas[0].id", equalTo("recData001"))
            .body("_embedded.receiptDatas[0].chainCode", equalTo("rcss"))
            .body("_embedded.receiptDatas[0].branchName", equalTo("Calgary Trail"))
            .body("_embedded.receiptDatas[0].parsedTotal", equalTo("10.45"))
            .body("_embedded.receiptDatas[0].parsedDate", equalTo("2015/11/11"))
            .body("_embedded.receiptDatas[0].items[0].id", equalTo("recItem003"))
            .body("_embedded.receiptDatas[0].items[0].lineNumber", equalTo(10))
            .body("_embedded.receiptDatas[0].items[0].catalogCode", equalTo("PORK"))
            .body("_embedded.receiptDatas[0].items[0].userDeleted", equalTo(false))
            .body("_embedded.receiptDatas[0].items[1].id", equalTo("recItem001"))
            .body("_embedded.receiptDatas[0].items[1].lineNumber", equalTo(15))
            .body("_embedded.receiptDatas[0].items[1].catalogCode", equalTo("EGG_1235"))
            .body("_embedded.receiptDatas[0].items[1].userDeleted", equalTo(false))
            .body("_embedded.receiptDatas[0].items[2].id", equalTo("recItem002"))
            .body("_embedded.receiptDatas[0].items[2].lineNumber", equalTo(18))
            .body("_embedded.receiptDatas[0].items[2].catalogCode", equalTo("MILK_1234"))
            .body("_embedded.receiptDatas[0].items[2].userDeleted", equalTo(true))
        ;
    }
