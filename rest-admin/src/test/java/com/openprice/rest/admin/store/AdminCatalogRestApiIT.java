...
public class AdminCatalogRestApiIT extends AbstractAdminStoreRestApiIntegrationTest {
    ...
    public void getCatalogs_ShouldReturnAllCatalogsOfStoreChain() {
        ...
        .then()
            ...
            .body("_embedded.catalogProducts[0].id", equalTo("chain001cat001"))
            .body("_embedded.catalogProducts[0].catalogCode", equalTo("MILK_1234"))
            .body("_embedded.catalogProducts[0].naturalName", equalTo("2% milk"))
            .body("_embedded.catalogProducts[0].productCategory", equalTo("dairy"))
            .body("_embedded.catalogProducts[1].id", equalTo("chain001cat002"))
            .body("_embedded.catalogProducts[1].catalogCode", equalTo("EGG_1235"))
            .body("_embedded.catalogProducts[1].naturalName", equalTo("Large Egg"))
            .body("_embedded.catalogProducts[1].productCategory", equalTo("meat"))
            .body("_embedded.catalogProducts[2].id", equalTo("chain001cat003"))
            .body("_embedded.catalogProducts[2].catalogCode", equalTo("PORK"))
            .body("_embedded.catalogProducts[2].naturalName", equalTo("Pork Meat"))
            .body("_embedded.catalogProducts[3].id", equalTo("chain001cat004"))
            .body("_embedded.catalogProducts[3].catalogCode", equalTo("BREAD"))
            .body("_embedded.catalogProducts[3].naturalName", equalTo("Breakfast bread"))
    ...
    public void getCatalogById_ShouldReturnCorrectCatalog() {
        ...
        .then()
            ...
            .body("naturalName", equalTo("2% milk"))
    ...
    public void uploadCatalogs_ShouldLoadCatalogJsonFile() throws Exception {
        ...
        .then()
            ...
            .body("_embedded.catalogProducts[2].catalogCode", equalTo("PORK"))
            .body("_embedded.catalogProducts[2].naturalName", equalTo("Pork Meat"))
            .body("_embedded.catalogProducts[2].productCategory", equalTo("meat"))
            .body("_embedded.catalogProducts[3].id", equalTo("chain001cat004"))
            .body("_embedded.catalogProducts[3].catalogCode", equalTo("BREAD"))
            .body("_embedded.catalogProducts[3].naturalName", equalTo("Breakfast bread"))
            .body("_embedded.catalogProducts[3].productCategory", equalTo("bakery"))
            .body("_embedded.catalogProducts[4].catalogCode", equalTo("beatrice 1% milk_06570010028"))
            .body("_embedded.catalogProducts[4].naturalName", equalTo("beatrice 1% milk"))
            .body("_embedded.catalogProducts[4].productCategory", equalTo("dairy"))
            .body("_embedded.catalogProducts[5].catalogCode", equalTo("blueberries_06038309313"))
            .body("_embedded.catalogProducts[5].naturalName", equalTo("blueberries"))
            .body("_embedded.catalogProducts[5].productCategory", equalTo("fruit"))
        ;
    }
}
